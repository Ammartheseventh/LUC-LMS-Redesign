    ...
    <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-5 card-transition flex flex-col justify-between gap-2">
      ...
      <ul className="divide-y divide-slate-100 text-xs">
        {essentialLinks.map((link, index) => (
          <li className="py-2.5 px-1 flex items-center justify-between group text-sm font-medium text-slate-700 hover:bg-slate-100 hover:text-brand-400 cursor-pointer transition">
